            ...
            <div class="col-12" id="manual" style="display: none;">
                <div class="mb-4">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th scope="col">Centroid 1 (Layak)</th>
                                <th scope="col">Centroid 2 (Dipertimbangkan)</th>
                                <th scope="col">Centroid 3 (Tidak Layak)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
...
<script>
    ...
    const next = () => {
            ...
            if(centroid == 'manual'){
                if(centroid1 == null || centroid2 == null || centroid3 == null){
                    alert('Centroid tidak boleh kosong');
                }else{
                    window.location.href = "{{route('kmeans.index')}}?centroid1="+centroid1+"&centroid2="+centroid2+"&centroid3="+centroid3+"&step=1";
                }
            }else{
                window.location.href = "{{route('kmeans.index')}}?centroid=random&step=1";
            }
        }
</script>
@endsection