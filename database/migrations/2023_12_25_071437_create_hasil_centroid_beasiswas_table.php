...
return new class extends Migration
{
    ...
    {
        Schema::create('hasil_centroid_beasiswa', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('c3g', 50)->nullable();
            $table->string('c4a', 50)->nullable();
            $table->string('c4b', 50)->nullable();
            $table->string('c4c', 50)->nullable();
            $table->string('c4d', 50)->nullable();
            $table->string('c4e', 50)->nullable();
            $table->string('c4f', 50)->nullable();
            $table->string('c4g', 50)->nullable();
    ...
    {
        Schema::dropIfExists('hasil_centroid_beasiswa');
    }
};
